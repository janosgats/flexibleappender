...
class LocaldevConsoleAppenderTest {
    private static final String ENABLER_PROP = "LOGGING_ENABLE_LOCALDEV_CONSOLE_APPENDER";
    private static final String CONFIG_FILE = "log4j2-localdev-test.xml";
